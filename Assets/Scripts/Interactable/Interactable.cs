...
public class Interactable : MonoBehaviour {
    ...
    public virtual void OpenInteractionMenu()
    {
        ...
        Instantiate(Resources.Load("Interactable/InteractionMenu"), menuSpawnPoint, Quaternion.identity, CanvasUI.instance.transform); //FindObjectOfType is iffy, might not always grab proper canvas
