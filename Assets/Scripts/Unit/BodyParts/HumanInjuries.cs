...
public class HumanInjuries : MonoBehaviour {
    ...
    */
    ...
    private static Dictionary<int, string>[] penetrationInjuries = new Dictionary<int, string>[] {
        ...
        {
            { 0, "The {1} cuts through {0}'s {2} and hacks deep into the head!" },
            { 1, "The {1} cuts through {0}'s {2} and hacks deep into the neck!"},
            { 2, "The {1} cuts through {0}'s {2} and hacks deep into the left arm!" },
            { 3, "The {1} cuts through {0}'s {2} and hacks deep into the right arm!" },
            { 4, "The {1} cuts through {0}'s {2} and hacks deep into the left hand" },
            { 5, "The {1} cuts through {0}'s {2} and hacks deep into the right hand!" },
            { 6, "The {1} cuts through {0}'s {2} and hacks deep into the chest!" },
            { 7, "The {1} cuts through {0}'s {2} and hacks deep into the belly!" },
            { 8, "The {1} cuts through {0}'s {2} and hacks deep into the left leg!" },
            { 9, "The {1} cuts through {0}'s {2} and hacks deep into the right leg!" },
            { 10, "The {1} cuts through {0}'s {2} and hacks deep into the left foot!" },
            { 11, "The {1} cuts through {0}'s {2} and hacks deep into the right foot!" },
        },
