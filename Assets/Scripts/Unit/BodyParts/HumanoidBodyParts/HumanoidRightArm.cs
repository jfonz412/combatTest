    ...
    protected override void SetInjuryStrings()
    {
        myInjuryStrings = new Dictionary<Item.AttackType, string[]>()
        {
            ...
            {Item.AttackType.BluntImpact, new string[]
                {
                     "The force of the {1} leaves a light bruise on {0}'s right arm!",
                     "The force of the {1} bruises {0}'s right arm!",
                     "The force of the {1} heavily bruises {0}'s right arm!",
                     "The force of the {1} cracking a bone in {0}'s right arm!",
                     "The force of the {1} crushes the bones of {0}'s right arm!",
                     "The force of the {1} completely pulverizes {0}'s right arm!"
                }
            },
            ...
            {Item.AttackType.Stab, new string[]
                {
                     "The {1} pokes at the skin of {0}'s right arm!",
                     "The {1} slices into flesh of {0}'s right arm!",
                     "The {1} stabs into {0}'s right arm!",
                     "The {1} stabs deep into {0}'s right arm!",
                     "The {1} seriously gores {0}'s right arm!",
                     "The blade of the {1} passes completely through {0}'s right arm!"
                }
            }
        };
