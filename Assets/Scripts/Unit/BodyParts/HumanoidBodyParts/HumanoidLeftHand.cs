...
public class HumanoidLeftHand : BodyPart
{
    ...
    protected override void SetInjuryStrings()
    {
        myInjuryStrings = new Dictionary<Item.AttackType, string[]>()
        {
            ...
            {Item.AttackType.BluntImpact, new string[]
                {
                     "The force of the {1} leaves a light bruise on {0}'s left hand!",
                     "The force of the {1} bruises {0}'s left hand!",
                     "The force of the {1} heavily bruises {0}'s left hand!",
                     "The force of the {1} cracks the bones in {0}'s left hand!",
                     "The force of the {1} crushes the bones of {0}'s left hand!",
                     "The force of the {1} completely obliterates {0}'s left hand!"
                }
            },
            ...
            {Item.AttackType.Stab, new string[]
                {
                     "The {1} pokes at the skin of {0}'s left hand!",
                     "The {1} slices at the skin of {0}'s left hand!",
                     "The {1} stabs into {0}'s left hand!",
                     "The {1} stabs completely through {0}'s left hand!",
                     "The {1} fractures the bones in {0}'s left hand!",
                     "The {1} completely mangles {0}'s left hand!"
                }
            }
        };
