    ...
    */
    ...
    private static Dictionary<BodyParts.Parts, string>[] penetrationInjuries = new Dictionary<BodyParts.Parts, string>[] {
        ...
        new Dictionary<BodyParts.Parts, string>() //scratch
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} ruptures {0}'s {2}, leaving a light scratch on the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} ruptures {0}'s {2}, leaving a light scratch on the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //{1} slices
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} pierces {0}'s {2}, slicing the flesh of the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} pierces {0}'s {2}, slicing the flesh of the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //deep cut
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} cuts through {0}'s {2} and hacks deep into the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} cuts through {0}'s {2} and hacks deep into the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //cut to bone
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} completely penetrates {0}'s {2}, cutting down to the bone of the the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} completely penetrates {0}'s {2}, cutting down to the bone of the the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //shatters bone
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} easily carves into {0}'s {2}, completely shatttering the bone of the the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} easily carves into {0}'s {2}, completely shatttering the bone of the the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //sever
        {
            ...
            {BodyParts.Parts.LeftArm, "The {1} effortlessly slices through {0}'s {2}, severing the front back left leg!" },
            {BodyParts.Parts.RightArm, "The {1} effortlessly slices through {0}'s {2}, severing the front back right leg!" },
    ...
    private static Dictionary<BodyParts.Parts, string>[] impactInjuries = new Dictionary<BodyParts.Parts, string>[] {
        ...
        new Dictionary<BodyParts.Parts, string>() //light bruise
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} dents {0}'s {2}, leaving a light bruise on the front back left leg!" },
            {BodyParts.Parts.RightArm, "The force of the {1} dents {0}'s {2}, leaving a light bruise on the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //bad bruise
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} dents {0}'s {2}, bruising the front back left leg!" },
            {BodyParts.Parts.RightArm, "The force of the {1} dents {0}'s {2}, bruising the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //heavy bruise
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} slams into {0}'s {2}, heavily bruising the front back left leg!" },
            {BodyParts.Parts.RightArm, "The force of the {1} slams into {0}'s {2}, heavily bruising the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //pulverize meat
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} crumples {0}'s {2}, pulverizing the meat of the front back left leg!" },
            {BodyParts.Parts.RightArm, "The force of the {1} crumples {0}'s {2}, pulverizing the meat of the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //bone shattering crush
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} crushes {0}'s {2}, the impact shatters the bones of the front back left leg!" },
            {BodyParts.Parts.RightArm, "The force of the {1} crushes {0}'s {2}, the impact shatters the bones of the front back right leg!" },
        ...
        new Dictionary<BodyParts.Parts, string>() //obliterates into mess
        {
            ...
            {BodyParts.Parts.LeftArm, "The force of the {1} smashes completely through {0}'s {2}, the front back left leg has been rendered totally useless!" },
            {BodyParts.Parts.RightArm, "The force of the {1} smashes completely through {0}'s {2}, the front back right leg has been rendered totally useless!" },
